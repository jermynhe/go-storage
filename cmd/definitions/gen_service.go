...
func generateSrv(data *Service, path string) {
	...
	f.NewImport().
		...
		AddPath("time").
		AddLine().
		AddDot("github.com/minhjh/go-storage/v4/pairs").
		AddPath("github.com/minhjh/go-storage/v4/pkg/httpclient").
		AddPath("github.com/minhjh/go-storage/v4/services").
		AddDot("github.com/minhjh/go-storage/v4/types")
