...
- RFC PR: [minhjh/specs#127](https://github.com/minhjh/specs/issues/127)
- Tracking Issue: [minhjh/go-storage#612](https://github.com/minhjh/go-storage/issues/612)
...
- Add them in the [doc](https://minhjh.io/docs/go-storage/internal/handling-errors#list-of-global-error-codes).
