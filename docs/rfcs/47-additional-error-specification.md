...
- RFC PR: [minhjh/specs#47](https://github.com/minhjh/specs/issues/47)
- Tracking Issue: N/A
...
[go-storage/services/error.go]: https://github.com/minhjh/go-storage/blob/master/services/error.go
