...
- RFC PR: [minhjh/go-storage#749](https://github.com/minhjh/go-storage/pull/749)
- Tracking Issue: [minhjh/go-storage#758](https://github.com/minhjh/go-storage/issues/758)

# GSP-749: Unify Path Behavior

Previous Discussion:

- [Specify the behavior of Path](https://forum.minhjh.io/t/topic/195)
- [OS-specific path separator problem](https://github.com/minhjh/go-service-ftp/issues/22)
...
Exception rules could be described in the RFC of the corresponding service. Path behavior for local file system is defined [here](https://github.com/minhjh/go-service-fs/pull/78).
